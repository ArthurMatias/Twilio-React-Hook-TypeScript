  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.toolbarTop}>
        <p style={styles.topbtn}><SendIcon style={{ fontSize: '50px' }} onClick={sendEdited} /></p>
        <p style={styles.topbtn}><SaveAltIcon style={{ fontSize: '50px' }} onClick={downloadEdited} /></p>
        <p style={styles.topbtn}><CancelIcon style={{ fontSize: '50px' }} onClick={props.handleClose} /></p>
      </div>
            ...
            <div style={{margin:'5px auto'}}>
              {arrColor.map((cc, i) => (
                <button key={i} className={"colorbtn" + (activeColor === cc ? " active" : "")}
                  onClick={(e) => setActiveColor(cc)}><FiberManualRecordIcon style={{ fontSize: 26, color: cc }} /></button>
              ))}
            </div>
            <div style={{display:'flex', flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
              {arrStroke.map((ss, i) => (
                <button key={i} className={"strokebtn" + (activeStroke === ss ? " active" : "")}
                  onClick={(e) => setActiveStroke(ss)}> <GestureIcon style={{ fontSize: 10 + ss * 2 }} /> </button>
              ))}
            </div>
          </div>
        </div>
